...
- One genre from Ishkur’s Guide that influences my listening habits is hip hop, especially its close relationship with electronic production like breakbeats and sampling. Seeing hip hop mapped alongside electronic styles made me more aware of how producers use drum machines, loops, and synths, which has led me to listen more closely to production-heavy hip hop and experimental rap tracks.
...
- Robert Moog helped change electronic music by making synthesizers playable for musicians, not just engineers. His Moog synthesizer let artists shape sound in real time with knobs and keyboards, which is why synths ended up in popular music instead of staying stuck in labs.
...
- I really like how Wendy Carlos uses synthesized sound in The Shining to create tension and unease without relying on traditional melodies. The Moog textures feel cold and mechanical, which fits the film’s themes of isolation and psychological breakdown. The music almost feels like another character shaping the mood of the scene.
[Example](https://www.youtube.com/watch?v=g_nsZ8yt1KA)
